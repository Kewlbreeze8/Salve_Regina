...
import io.github.kewlbreeze8.Ingame.Others.Mechanic.Choice;
...
public class StoryManager {
    ...
    public static StoryNode loadChapter(String chapterKey, String startNodeOverride) {
        ...
        System.out.println("[loadChapter] scenes loaded = " + scenes.size());
        ...
        System.out.println("[loadChapter] currentNode = " + currentNode);        
    ...
    public static void clearEverything() {
        clearCurrentChapter();
        System.out.println("[loadChapter] clearCurrentChapter finished");
        penanceManager = null;
