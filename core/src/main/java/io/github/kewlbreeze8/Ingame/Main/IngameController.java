package io.github.kewlbreeze8.Ingame.Main;
...
import io.github.kewlbreeze8.Ingame.Others.Mechanic.PenanceManager;
import io.github.kewlbreeze8.Ingame.Others.Story.Action;
import io.github.kewlbreeze8.Ingame.Others.Story.Line;
import io.github.kewlbreeze8.Ingame.Others.Story.StoryActionExecutor;
import io.github.kewlbreeze8.Ingame.Others.Story.StoryNode;
import io.github.kewlbreeze8.Ingame.Others.Video.VideoService;
import io.github.kewlbreeze8.Menu.Main.LoadGame;
import io.github.kewlbreeze8.Menu.Main.MainMenu;
import io.github.kewlbreeze8.Menu.Main.Options;
import io.github.kewlbreeze8.Menu.Others.Audio.AudioManager;
import io.github.kewlbreeze8.Menu.Others.System.Assets;
import io.github.kewlbreeze8.Menu.Others.System.GameInstance;
import io.github.kewlbreeze8.Menu.Others.System.SaveManager;
import io.github.kewlbreeze8.Menu.Others.System.SlotUtil;
import io.github.kewlbreeze8.Ingame.Main.IngameCrew.ButtonPanel;
...
public class IngameController implements Screen {
    ...
    public void runCurrentNode() {
        ...
        System.out.println("Node Type: " + currentNode.type);
        System.out.println("Actions:");

        if (currentNode.getActions() != null) {
            for (Action a : currentNode.getActions()) {
        ...
        if (nodeActions != null && !nodeActions.isEmpty()) {
            ...
            boolean paused = actionExecutor.execute(nodeActions);
            System.out.println("[runCurrentNode] paused = " + paused);

            if (paused) {
/*
                // If StoryManager changed the node, continue immediately.
                if (StoryManager.getCurrentNode() != currentNode) {
                    runCurrentNode();
                }
*/
                return;
        ...
        while (index < currentNode.lines.size()) {
            ...
            if (line.text == null || line.text.isEmpty()) {
                ...
                if (line.action != null) {
                    ...
                    boolean paused = actionExecutor.execute(actions);
    ...
    public void playVideo(String fileName, String nextNodeId, boolean isEnding, String penanceLevel) {
        ...
        VideoService.playVideo(fileName, () -> {
            ...
            if (isEnding) {
                ...
                // We'll recreate the ending sequence here later.
                System.out.println("[DEBUG] Ending video finished.");

            } else {

                StoryManager.setCurrentNode(nextNodeId);
...
//        System.out.println("IngameController render");
    ...
    public PenanceManager getPenanceManager() {
